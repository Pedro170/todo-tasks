...
const updatedTodoEntity = new TodoEntity({ task: 'updated-trask', isDone: 1 });
...
describe('TodoService', () => {
  ...
  describe('update', () => {
    it('should update a todo entity item successfully', async () => {
      ...
      jest.spyOn( todoRepository, 'save' ).mockResolvedValueOnce( updatedTodoEntity );
  ...
  describe('removeId', () => {
    it('should delete a todo entity item successfully', async () => {
      // Act
      const result = await todoService.removeId('1');
    ...
    it('should throw a not found exception', () => {
      ...
      // Assert
      expect( todoService.removeId('1') ).rejects.toThrowError( NotFoundException );
    })
    ...
    it('should throw an exception', () => {
      ...
      // Assert
      expect( todoService.removeId('1') ).rejects.toThrowError();
    })
  })
});
